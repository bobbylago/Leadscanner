...
export const CITY_PRESETS: CityPreset[] = [
  ...
  { label: "Stockton, CA",      country: "US", region: "California"},
  ...
  { label: "Stockbridge, GA",   country: "US", region: "Southeast" },
  ...
  { label: "Stockport, UK",  country: "GB" },
  { label: "Stockton-on-Tees, UK", country: "GB" },
